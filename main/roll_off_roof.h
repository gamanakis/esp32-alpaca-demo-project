...
public:
  virtual esp_err_t action(const char *action, const char *parameters,
                           char *buf, size_t len) override;
  virtual esp_err_t commandblind(const char *command, bool raw) override;
  virtual esp_err_t commandbool(const char *command, bool raw,
                                bool *resp) override;
  virtual esp_err_t commandstring(const char *action, bool raw, char *buf,
                                  size_t len) override;
  ...
  virtual esp_err_t
  get_supportedactions(std::vector<std::string> &actions) override;
